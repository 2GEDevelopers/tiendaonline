...
CREATE TABLE subcategoria (id BIGINT AUTO_INCREMENT, nombre VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE direccion ADD CONSTRAINT direccion_usuario_id_marca_id FOREIGN KEY (usuario_id) REFERENCES marca(id);
